...
public static class PlayerHelperFunctions{
    public static RaycastHit ViewRay(float maxDist){
        Physics.Raycast(GameManager.playerCamera.transform.position, GameManager.playerCamera.transform.forward, out RaycastHit _ray, maxDist);
        return _ray;
    }   
